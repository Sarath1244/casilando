		     ...
		     Thread.sleep(2000);
				  //Hamburger menu site &  My profile click  
				  	...
				  	//GameHistory Menu 
				  	  ...
				  	  Thread.sleep(2000);			    
				  	     //RAF  
				             ...
				             test.log(LogStatus.PASS, "RAF Verified", "To open Screenshots : <a href=' "	+ Baseclass.takeSnapShot() + " ' target=\\\"_blank\\  >Click Here</a>");
				    			}
				    			catch(Exception f10)
				    			{
		  	     ...
		  	     //Settings  
		             ...
		             test.log(LogStatus.PASS, "My Settings Verified", "To open Screenshots : <a href=' "	+ Baseclass.takeSnapShot() + " ' target=\\\"_blank\\  >Click Here</a>");
		    			}
		    			catch(Exception f10)
		    			{
